...
class MyPageListData extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        {list.map((row, index) => (
          <div key={index} style={{display: "inline-block", float: "right"}}>
            {/* <img
              src={burgerImg}
              alt="default"
            ...
            {whichView === "project" ? (
              <Table key={row.projectNo} style={{width: "100%" , display: "inline-block", paddingRight: "500px"}}>
                <colgroup>
            ...
            {whichView === "store" ? (
              <Table key={row.ownerNo} style={{width: "100%",display: "inline-block", paddingRight: "500px"}}>
                <colgroup>
                  <col style={{ width: "200px" }} />
                  <col style={{ width: "500px" }} />
                </colgroup>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>{row.mainMenu}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            ) : (
