...
import ReviewAdd  from '../StoreReview/ReviewAdd.scss';
...
class ReviewAddUserComponent extends Component{
    ...
    constructor(props){
        ...
        this.state ={
            ...
            ownerNo: window.localStorage.getItem("ownerNo"),
            reviewDate:'',
            star: '',
            contents: '',
            message: null
    ...
    saveReview = (e) => {
        ...
        axios.post('http://localhost:9999/storereview', storereview, {})
    ...
    render(){
        ...
        return(
            ...
            <div>
                <Typography id="reviewtitle" style={style}>리 뷰 작 성</Typography>
...
{/* 
                <TextField type="text" placeholder="nickname" fullWidth margin="normal" name="nickname" value={this.state.nickname} onChange={this.onChange}/>
                    ...
                    <TextField type="text" placeholder="리뷰를 남겨주세요!" fullWidth margin="normal" name="contents" value={this.state.contents} onChange={this.onChange}/>

                    <Button variant="contained" id="savebtn" onClick={this.saveReview}>Save</Button>
            </form>
    </div>
        );
    }
