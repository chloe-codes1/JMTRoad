...
class ApiService {
    ...
    loadstorelike(userNo,ownerNo){
        return axios.get('http://localhost:9999/owners/loadstoreLike/'+userNo+'/'+ownerNo)
    }
    ...
    //***** 음식점 페이지의 리뷰작성부분 **********
    fetchReviews() {
        return axios.get('http://localhost:9999/storereview');
    }

    ownerReviews(ownerNo) {
