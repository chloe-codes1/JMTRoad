...
public class StoreInfoServiceImpl implements StoreInfoService {
    ...
    @Override
    public StoreInfoDto update(StoreInfoDto StoreReviewDto) {
        StoreInfo store = findById(StoreReviewDto.getOwnerNo());
        if(store != null) {
            BeanUtils.copyProperties(StoreReviewDto, store, "BRNo", "storeName");
    ...
    @Override
    public StoreInfo save(StoreInfoDto storeinfo) {
